...
def run_checks(*, strict_env: bool = False) -> list[CheckResult]:
    checks = [
        ...
        _exists("billing_service/requirements.txt"),
        ...
        _env_any("cookie-password", ("COOKIE_PASSWORD",), required=strict_env),
        _env_any("billing-api-base", ("BILLING_API_BASE",), required=strict_env),
        _env_any("stripe-secret-key", ("STRIPE_SECRET_KEY",), required=strict_env),
        _env_any("stripe-webhook-secret", ("STRIPE_WEBHOOK_SECRET",), required=strict_env),
        _env_any("stripe-price-pro", ("STRIPE_PRICE_PRO",), required=strict_env),
        _env_any("stripe-price-premium", ("STRIPE_PRICE_PREMIUM",), required=strict_env),
        _env_any("app-success-url", ("APP_SUCCESS_URL",), required=strict_env),
        _env_any("app-cancel-url", ("APP_CANCEL_URL",), required=strict_env),
